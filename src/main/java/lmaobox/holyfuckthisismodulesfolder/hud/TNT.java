...
public class TNT extends HudElement {
    ...
    public void render(HudRenderer renderer) {
        ...
        if (isInEditor()) {
            RenderUtils.drawItem(Items.TNT.getDefaultStack(), (int) x, (int) y, scale.get(), true);
        } else if (InvUtils.find(Items.TNT).getCount() > 0) {
            RenderUtils.drawItem(new ItemStack(Items.TNT, ItemCounter.tnt()), (int) x, (int) y, scale.get(), true);
        }
    }
}
