...
import lmaobox.holyfuckthisismodulesfolder.categories.category.TNTAura;
import lmaobox.holyfuckthisismodulesfolder.categories.category.BedAuraPlus;
import lmaobox.holyfuckthisismodulesfolder.categories.category.ImprovedAutoCity;
import lmaobox.holyfuckthisismodulesfolder.categories.category.NewSurround;
import lmaobox.holyfuckthisismodulesfolder.categories.category.ImprovedHoleFiller;
...
public class AutoPotions extends Module {
    private static final Class<? extends Module>[] AURAS = new Class[] { KillAura.class, CrystalAura.class, AnchorAura.class, ImprovedAnchorAura.class, BedAuraPlus.class, BedAura.class, TNTAura.class, ImprovedAutoCity.class, NewSurround.class, ImprovedHoleFiller.class };
    ...
    public AutoPotions() {
        super(LmaoBoxGetGoodChangeYourGamesenseAndNeverLoseByJackesparragosAndMore.CATEGORY, "Auto-Potions", "Automatically Drinks Potions");
    }
