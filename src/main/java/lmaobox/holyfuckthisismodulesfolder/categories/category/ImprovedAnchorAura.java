...
public class ImprovedAnchorAura extends Module {
    ...
    public ImprovedAnchorAura() {
        super(LmaoBoxGetGoodChangeYourGamesenseAndNeverLoseByJackesparragosAndMore.CATEGORY, "Improved-AnchorAura", "Anchor aura mode.");
    }
