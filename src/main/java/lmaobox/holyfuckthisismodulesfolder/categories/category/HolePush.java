...
public class HolePush extends Module {
    ...
    public HolePush() {
        super(LmaoBoxGetGoodChangeYourGamesenseAndNeverLoseByJackesparragosAndMore.CATEGORY, "hole-push", "");
    }
    ...
    private BlockPos findPlace(PlayerEntity target) {
        if (!InvUtils.findInHotbar(Items.PISTON).found()) return null;
    ...
    private boolean placeBed(BlockPos pos) {
        ...
        FindItemResult bed = InvUtils.findInHotbar(Items.PISTON);
