...
import lmaobox.nomodulesfolder.player.InvHelper;
...
public class BedAutoCrafter extends Module {
    ...
    public BedAutoCrafter() {
        super(LmaoBoxGetGoodChangeYourGamesenseAndNeverLoseByJackesparragosAndMore.CATEGORYTHIRD, "Bed-Auto-Crafter", "Automatically craft beds.");
    }
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (automatic.get() && needsRefill() && canRefill(true) && !isOutOfMaterial() && !(mc.player.currentScreenHandler instanceof CraftingScreenHandler)) {
            ...
            if (!toggledBa && Modules.get().get(BedAuraPlus.class).isActive()) {
                toggledBa = true;
