...
public class ImprovedAutoCity extends Module {
    ...
    public ImprovedAutoCity() {
        super(LmaoBoxGetGoodChangeYourGamesenseAndNeverLoseByJackesparragosAndMore.CATEGORY, "improved-auto-city", "auto city plus.");
    ...
    public void onActivate() {
        ...
        target = null;
        shouldCount = false;
		if (Util.getMeasuringTimeMs() > start_time + 1000) {
			toggle();
		}
    @EventHandler
    @Override
