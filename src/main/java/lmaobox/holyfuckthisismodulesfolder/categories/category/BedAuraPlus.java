...
public class BedAuraPlus extends Module {
    ...
    public BedAuraPlus() {
        super(LmaoBoxGetGoodChangeYourGamesenseAndNeverLoseByJackesparragosAndMore.CATEGORY, "bed-aura-+", "Automatically places and explodes beds in the Nether and End.");
    }
