...
package lmaobox.nomodulesfolder.player;
...
//        if (Config.get().rainbowPrefix) {
     //       meteor.append(new LiteralText("熟").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
     //       meteor.append(new LiteralText("達").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
    //        meteor.append(new LiteralText("し").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
    //        meteor.append(new LiteralText("た").setStyle(meteor.getStyle().withColor(new TextColor(RAINBOW.getNext().getPacked()))));
    //    } else {
     //       meteor = new LiteralText("熟達した");
     //       meteor.setStyle(meteor.getStyle().withFormatting(Formatting.RED, Formatting.ITALIC, Formatting.BOLD));
     //   }

        prefix.setStyle(prefix.getStyle().withFormatting(Formatting.RED, Formatting.ITALIC, Formatting.BOLD));
        prefix.append("[");
